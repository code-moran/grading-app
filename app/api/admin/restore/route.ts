...
// GET /api/admin/restore/validate - Validate backup file without restoring
export async function GET(request: NextRequest) {
  try {
    ...
    const backupDataParam = searchParams.get('backupData');
    ...
    try {
      backupData = JSON.parse(backupDataParam);
    } catch (error) {
      return NextResponse.json(
