      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center py-16 md:py-24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/auth/signin"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-gray-700 rounded-lg font-semibold text-lg border-2 border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Rubric-Based Grading</h3>
            <p className="text-gray-600">Detailed assessment criteria with clear expectations and instant feedback.</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100">
            ...
            <p className="text-gray-600">Monitor your learning journey with visual progress indicators and analytics.</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100">
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="text-center mt-8">
                <Link
                  href="/courses"
                  className="inline-flex items-center px-6 py-3 bg-white text-gray-700 rounded-lg font-medium border-2 border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all"
                >
                  View All Courses
        ...
        <div className="text-center py-16 mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/courses"
              className="inline-flex items-center px-8 py-4 bg-white text-gray-700 rounded-lg font-semibold text-lg border-2 border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all"
            >
              Browse Courses
            </Link>
          </div>
